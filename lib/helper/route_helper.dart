...
import '../features/brands/screens/brands_product_screen_cat.dart';
...
class RouteHelper {
  ...
  static const String brandsItemScreenCat = '/brands-item-screen-cat';
  ...
  static String getBrandsItemScreen(int brandId, String brandName, String category_id ) => '$brandsItemScreen?brandId=$brandId&brandName=$brandName&category_id=$category_id';
  static String getBrandsItemScreenCat(int brandId, String brandName, String category_id ) => '$brandsItemScreenCat?brandId=$brandId&brandName=$brandName&category_id=$category_id';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: brandsItemScreenCat, page: () => BrandsItemScreenCat(
      brandId: int.parse(Get.parameters['brandId']!), brandName: Get.parameters['brandName']!, catId: '',
    )),
