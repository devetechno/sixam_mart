...
class _ItemsViewState extends State<ItemsView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      !isNull ? length > 0 ?
      AppConstants.itemsgried && widget.isStore == false ? GridView.builder(
    //scrollDirection: Axis.vertical,
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisSpacing: Dimensions.paddingSizeLarge,
          mainAxisSpacing: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeLarge : 0.01,
          childAspectRatio: ResponsiveHelper.isDesktop(context) ? widget.isStore ? 1.1 : 0.9 : 0.6,
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: ItemCard(item: widget.items![index]!, isPopularItem: false, isFood: false, isShop: true),
        );
      },
    ) :
      GridView.builder(
